...
NOCTURNED_TEST_SRC_NAMES := $(notdir $(wildcard tests/test_db.c tests/test_lock.c tests/test_hash.c tests/test_scan.c tests/test_watch.c tests/test_doctor.c tests/test_config.c tests/test_resolver.c tests/test_publisher.c tests/test_round_trip.c tests/test_migrate.c tests/test_rotate.c tests/test_syncthing_api.c tests/test_sync_config.c tests/test_jsonl.c tests/test_ingest.c tests/test_why.c tests/test_resolve_diff.c))
